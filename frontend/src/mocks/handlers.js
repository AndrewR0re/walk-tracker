...
export const handlers = [
    ...
    http.get('/api/munros', () => {
        return HttpResponse.json([
            { id: 1, name: 'Mayar', altitude: 913, date: '24/12/2017' },
            { id: 2, name: 'Dreish', altitude: 907, date: '24/12/2017' },
            { id: 3, name: 'Sgùrr na Banachdich', altitude: 965, date: '10/08/2019' },
            { id: 4, name: 'Mount Keen', altitude: 939, date: '24/04/2021' },
            { id: 5, name: 'Ben More', altitude: 913, date: '29/10/2024' },
            { id: 6, name: 'Càrn Aosda', altitude: 915, date: '12/07/2025' },
